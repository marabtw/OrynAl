...
const menu = [
  {
    ...
    to: ROUTERS.MyRestaurants,
  },
  {
    label: "История заказов",
    icon: <HistoryIconForHeader />,
    to: ROUTERS.OrderHistory,
  },
]
  ...
  return (
    ...
    >
      ...
      <div className="h-[25%] flex gap-[36px] items-center">
        <Link to={ROUTERS.MyRestaurants} className="h-full max-md:hidden">
          <img
            src={Logo}
            alt="logo"
        ...
        <Link to={ROUTERS.MyRestaurants} className="max-md:hidden">
          Мои рестораны
        </Link>
        <Link to={ROUTERS.OrderHistory} className="max-md:hidden">
          История заказов
        </Link>
      </div>
