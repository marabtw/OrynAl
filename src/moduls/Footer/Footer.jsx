    ...
    <footer className="px-[30px] py-[100px] flex flex-col gap-[150px]">
      <div className="grid grid-cols-3 gap-[30px] max-md:grid-cols-1 [font-size:_clamp(.9rem,3vw,25px)] [line-height:_clamp(.9rem,3vw,22.5px)]">
        <div className="text-center mx-auto max-md:max-w-[50%]">
					<LinearGradientText tag="h2" text={statistics.booking} from={"#6AA7FC"} to={"#3D6FFB"} className="font-[600]" clampsObject={{
						fontSize: "clamp(3rem,9vw,100px)", 
						lineHeight: "clamp(3rem,9vw,90px)",
					}}/>
          <p className="mt-[10px]">Заявок на бронь столиков полученные от нас рестораны, кафе.</p>
        </div>
        <div className="text-center mx-auto max-md:max-w-[50%]">
					<LinearGradientText tag="h2" text={statistics.people} from={"#6AA7FC"} to={"#3D6FFB"} className="font-[600]" clampsObject={{
						fontSize: "clamp(3rem,9vw,100px)", 
						lineHeight: "clamp(3rem,9vw,90px)",
					}}/>
          <p className="mt-[10px]">Заявок на бронь столиков полученные от нас рестораны, кафе.</p>
        ...
        <div className="text-center mx-auto max-md:max-w-[50%]">
					<LinearGradientText tag="h2" text={statistics.establishments} from={"#6AA7FC"} to={"#3D6FFB"} className="font-[600]" clampsObject={{
						fontSize: "clamp(3rem,9vw,100px)", 
						lineHeight: "clamp(3rem,9vw,90px)",
					}}/>
          <p className="mt-[10px]">Заявок на бронь столиков полученные от нас рестораны, кафе.</p>
