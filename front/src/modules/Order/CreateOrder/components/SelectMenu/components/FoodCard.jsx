  ...
  return (
    <div
      className="relative flex flex-col items-center justify-between w-full h-[362px] px-[30px] py-[40px] font-poppins transition-all duration-200 
		 border border-[#c4c4c4] shadow-[0px_4px_4px_rgba(0,0,0,.25)] rounded-[50px] hover:border-[#447bfb]"
    >
      ...
      <div className="flex justify-between items-center w-full">
        <div
          className="flex justify-center items-center text-[24px] text-white w-[50px] aspect-square cursor-pointer bg-[#6AA7FC] rounded-full"
          onClick={() => {}}
        >
          <CircleAddIcon />
        </div>
