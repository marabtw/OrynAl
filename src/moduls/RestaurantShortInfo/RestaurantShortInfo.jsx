...
const RestaurantShortInfo = ({ data, className }) => {
  return (
    <div className={`w-full  bg-white rounded-[20px] ${className}`}>
      <div className="grid grid-cols-[133px_minmax(0px,1fr)] gap-x-[20px] gap-y-[10px]">
        <img src={data.icon} alt="icon" className="w-[133px] rounded-full" />
      ...
      <div className="grid grid-cols-2 grid-rows-[repeat(3,55px)] gap-x-[10px] gap-y-[10px] mt-[50px]">
